    ...
    return <>
        <section className="flex items-center justify-center py-10 text-white bg-white sm:py-16 md:py-24 lg:py-32">
            <div className="relative max-w-3xl px-10 text-center text-white auto lg:px-0">
                ...
                <p className="text-left text-gray-500 xl:text-justify">
                    Estes termos e condições descrevem as regras de uso do site da empresa iBurger, localizada no endereço https://iburger.vercel.app/.
                </p>
                <p className="text-left text-gray-500 my-4 xl:text-justify">
                    Ao acessar este site, consideramos que você está de acordo com os termos e condições abaixo. Não continue a usar o iburger caso você discorde dos termos e condições descritos neste contrato.
                </p>

                <h4 className="text-left text-gray-800 my-4 xl:text-xl">Cookies</h4>
                <p className="text-left my-2 text-gray-500 xl:text-justify">
                    O site usa cookies para ajudar na pesonalização da sua experiência na internet. Ao acessar o site iburger, você concorda com o uso dos cookies requeridos.
                </p>
                ...
                <h4 className="text-left text-gray-800 my-4 xl:text-xl">Licença</h4>
                <p className="text-left text-gray-500 xl:text-justify">
                    Exceto em casos em que for indicado o contrário, iBurger e seus licenciados têm direito à propriedade intelectual de todo o material postado no iburger. Todos os direitos à propriedade intelectual são reservados.

                    <h6 className="mt-2 text-gray-900">Você não tem permissão para:</h6>

                    <ul className="my-2 list-disc">
                        <li className="ml-8">Copiar ou republicar materiais do iburger</li>
                        <li className="ml-8">Vender, alugar ou sublocar materiais do iburger</li>
                        <li className="ml-8">Reproduzir, duplicar ou copiar materiais do iburger</li>
                        <li className="ml-8">Redistribuir conteúdos do iburger</li>
                    </ul>
                    ...
                    <p className="text-left my-2 text-gray-500 xl:text-justify">
                        Partes deste site oferecem ao usuário a oportunidade de postar e discutir opiniões e informações em determinadas áreas. iBurger não filtra, edita, publica ou revisa Comentários antes que eles sejam apresentados no site. Comentários refletem as opiniões da pessoa que os posta. Na extensão em que as leis aplicáveis permitem, iBurger não se responsabiliza legalmente pelos Comentários ou quaisquer danos, riscos ou despesas causadas ou sofridas como resultado do uso, e/ou postagem e/ou aparência dos Comentários deste site.
                    </p>
                    <p className="text-left my-2 text-gray-500 xl:text-justify">
                        iBurger reserva para si o direito de recomer quaisquer Comentários que possa ser considerado inapropriado, ofensivo ou quebre os Termos e Condições deste contrato.
                    </p>

                    <h6 className="mt-2 text-gray-900">Você declara e garante que:</h6>

                    <ul className="my-2 list-disc">
                        <li className="ml-8">Você tem o direito de postar Comentários em nosso site e tem todas as licenças e consentimentos para tal;</li>
                        <li className="ml-8">Os Comentários não invadem qualquer propriedade intelectual, incluindo direitos autorais, patentes ou marcas registradas de terceiros;</li>
                        <li className="ml-8">Os Comentários não contém material difamatório, injurioso, ofensivo, indecente ou de alguma forma ilícito, que é invasão de privacidade.</li>
                        <li className="ml-8">Os Comentários não serão usados para solicitar ou promover negócios ou apresentar atividades comerciais ou atividades ilícitas.</li>
                    </ul>

                    <p className="text-left my-2 text-gray-500 xl:text-justify">
                        Você por meio deste concede a iBurger a licença não-exclusiva de usar, reproduzir, editar e autorizar outros a usar, reproduzir ou editar qualquer um de seus Comentários em qualquer e todas as formas, formatos e mídias.
                        Criação de links para nosso conteúdo
                    </p>

                    <h6 className="mt-2 text-gray-900">As seguintes organizações podem criar links para nosso Site sem a necessidade de aprovação prévia por escrito:</h6>
                    <ul className="my-2 list-disc">
                        <li className="ml-8">Agências governamentais;</li>
                        <li className="ml-8">Agentes de publicidade;</li>
                        <li className="ml-8">Mecanismos de busca;</li>
                        <li className="ml-8">Organizações de mídia;</li>
                        <li className="ml-8">Organizações de marketing;</li>
                        <li className="ml-8">Distribuidores de diretórios online podem inserir links para nosso Site na mesma maneira que inserem hiperlinks para Sites de outras empresas listadas;</li>
                        <li className="ml-8">Empresas credenciadas, exceto organizações angariantes sem fins lucrativos e grupos de arrecadação de fundos para instituições de caridade, que não podem inserir links para nosso Site sem aprovação prévia.</li>
                    </ul>
                    <p className="text-left my-2 text-gray-500 xl:text-justify">
                    ...
                    Se você representa uma das organizações listadas no parágrafo 2 acima e está interessado em postar um link para nosso site, você deve nos informar de seu interesse enviando um e-mail para iBurger. Por favor, inclua seu some, o nome da sua organização e suas informações de contato, assim como a URL do seu site, uma lista das URLs do nosso site que você pretende usar como links, e uma lista dos sites nos quais você pretende publicar nossas URLs. Aguarde entre 2 e 3 semanas para receber uma resposta.
                    ...
                    Não será permitido o uso ou a publicação de links para o logo e/ou outros elementos visuais da iBurger sem um acordo de licença para o uso da marca registrada.
